...
def copy_blob_to_uri(
  ...
  if (
      source_uri_gcp_project is None
      or not source_uri_gcp_project
      or source_uri_gcp_project == _CloudStorageClientProjectState.gcp_project()
  ):
